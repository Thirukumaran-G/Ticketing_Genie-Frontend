...
export interface ConversationItem {
  id: string; author_id: string; author_type: 'customer' | 'agent';
  content: string; is_internal: boolean; is_ai_draft: boolean;
  created_at: string; updated_at: string;
}
export interface AttachmentItem {
  id: string; ticket_id: string; file_name: string;
